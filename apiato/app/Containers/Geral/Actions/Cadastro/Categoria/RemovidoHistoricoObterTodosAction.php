...
class RemovidoHistoricoObterTodosAction extends Action
{
    public function run(Request $request)
    {
        ...
        $registro = Apiato::call('Geral@Cadastro\Categoria\ObterRegistroTask', [$request->id, true], ['removeRequestCriteria']);
        if (!$registro) {
            throw new NotFoundException('Registro não encontrado.');
        }
        $registros = Apiato::call('Geral@Cadastro\Categoria\HistoricoObterTodosTask', [$registro, $dataTablesRequest], ['addRequestCriteria']);
