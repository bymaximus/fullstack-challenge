...
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\ObterTodosRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\AdicionarRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\RemoverRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\ObterRegistroRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\AtualizarRegistroRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\HistoricoObterTodosRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\HistoricoObterRegistroRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\RemovidoObterTodosRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\RemovidoHistoricoObterTodosRequest;
use App\Containers\Geral\UI\WEB\Requests\Cadastro\Categoria\RemovidoHistoricoObterRegistroRequest;
use App\Containers\Geral\UI\WEB\Transformers\Cadastro\CategoriaTransformer;
use App\Containers\Geral\UI\WEB\Transformers\Cadastro\CategoriaHistoricoTransformer;
 ...
 */
class CategoriaController extends CommonController
{
    use ResponseTrait;
    ...
    public function index(ObterTodosRequest $request)
    {
        ...
        return Apiato::call('Geral@Cadastro\Categoria\ObterTodosAction', [$request])->editColumn('dt_criacao', function ($registro) {
    ...
    public function indexHistorico(HistoricoObterTodosRequest $request)
    {
        ...
        return Apiato::call('Geral@Cadastro\Categoria\HistoricoObterTodosAction', [$request])->filterColumn('user.usuario', function ($query, $keyword) {
    ...
    public function indexRemovido(RemovidoObterTodosRequest $request)
    {
        ...
        return Apiato::call('Geral@Cadastro\Categoria\RemovidoObterTodosAction', [$request])->editColumn('dt_criacao', function ($registro) {
            return $registro->dt_criacao ? with(new Carbon($registro->dt_criacao))->format('d/m/Y H:i:s') : '';
        })->editColumn('dt_alteracao', function ($registro) {
            return $registro->dt_alteracao ? with(new Carbon($registro->dt_alteracao))->format('d/m/Y H:i:s') : '';
    ...
    public function indexRemovidoHistorico(RemovidoHistoricoObterTodosRequest $request)
    {
        ...
        return Apiato::call('Geral@Cadastro\Categoria\RemovidoHistoricoObterTodosAction', [$request])->filterColumn('user.usuario', function ($query, $keyword) {
        })->editColumn('created_at', function ($registro) {
            return $registro->created_at ? with(new Carbon($registro->created_at))->format('d/m/Y H:i:s') : '';
        })->editColumn('event', function ($registro) {
            return $registro->evento;
    ...
    public function remover(RemoverRequest $request)
    {
        ...
        $model = Apiato::call('Geral@Cadastro\Categoria\RemoverAction', [$request]);
        if ($model &&
            $model->id > 0
        ) {
    ...
    public function adicionar(AdicionarRequest $request)
    {
        ...
        $model = Apiato::call('Geral@Cadastro\Categoria\AdicionarAction', [$request]);
        if ($model &&
            $model->id > 0
        ) {
            return response()->json([
    ...
    public function obterRegistro(ObterRegistroRequest $request)
    {
        ...
        $model = Apiato::call('Geral@Cadastro\Categoria\ObterRegistroAction', [$request]);
        if ($model &&
            $model->id > 0
        ) {
            $lists = [];
            ...
            $resource = new Item($model, new CategoriaTransformer);
    ...
    public function obterHistoricoRegistro(HistoricoObterRegistroRequest $request)
    {
        ...
        $model = Apiato::call('Geral@Cadastro\Categoria\HistoricoObterRegistroAction', [$request]);
        if ($model &&
            $model->id > 0
        ) {
            $lists = [];
            ...
            $resource = new Item($model, new CategoriaHistoricoTransformer);
            $lists['registro'] = $manager->createData($resource)->toArray();
    ...
    public function atualizar(AtualizarRegistroRequest $request)
    {
        ...
        $model = Apiato::call('Geral@Cadastro\Categoria\AtualizarRegistroAction', [$request]);
        if ($model &&
            $model->id > 0
        ) {
            return response()->json([
