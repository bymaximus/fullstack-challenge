...
class ObterSubCategoriasRequest extends Request
{
     ...
     * @var string
     */
    protected $transporter = \App\Containers\Geral\Data\Transporters\Cadastro\Produto\ObterSubCategoriasTransporter::class;
