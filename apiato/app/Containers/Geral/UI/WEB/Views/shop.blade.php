...
<head>
	...
	<link rel="stylesheet" href="{{ asset(mix('container/admin/css/shop.css')) }}">
...
<body>
	...
	<script src="{{ asset(mix('container/admin/js/shop/manifest.js')) }}"></script>
	<script src="{{ asset(mix('container/admin/js/shop/vendor.js')) }}"></script>
	<script src="{{ asset(mix('container/admin/js/shop.js')) }}"></script>
</body>
